...
Responsibilities
Vedant Patel: Implemented the ADD, LIST, and QUIT functions on the server side. Implemented the DELETE and SHUTDOWN functions, along with the client-side communication handling